...
class Cambridge(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_k = [torch.Tensor(self.img_k.copy()) for i in indexs]
        K_tensor = torch.stack(img_k, dim=0)
        ...
        frame['T'] = T_tensor.squeeze(0)
        frame['K'] = K_tensor.squeeze(0)
        frame['image'] = images.squeeze(0)
