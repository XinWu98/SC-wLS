...
# opencv_inc_dir = '/usr/local/include' # directory containing OpenCV header files
# opencv_lib_dir = '/usr/local/lib' # directory containing OpenCV library files

# conda, must have opencv in conda_env/include
#opencv_inc_dir = ''
#opencv_lib_dir = ''

opencv_inc_dir = '/usr/local/opencv3.4/include' # directory containing OpenCV header files
opencv_lib_dir = '/usr/local/opencv3.4/lib' # directory containing OpenCV library files
